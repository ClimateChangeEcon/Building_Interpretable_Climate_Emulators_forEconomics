...
constants = {'Tstep': 1, # Years in one time step
            ...
            'pow2': 2.,
            #----------------Carbon mass---------------------------------
            'b12_': 0.0209867,   # Rate of carbon diffusion from atmosphere to upper ocean
            'b23_': 0.0025073,   # Rate of carbon diffusion from upper ocean to lower ocean
            'b14_': 0.0665698,  # Rate of carbon diffusion from atmosphere to land biosphere
            'MATeq': 0.589, # Equilibrium mass of carbon in the Atmosphere
            'MUOeq': 0.763, # Equilibrium mass of carbon in the upper Ocean
            'MLOeq': 37.227, #Equilibrium mass of carbon in the lower ocean
            'MLFeq': 0.323, #Equilibrium mass of carbon in the lower ocean
            #-------------------Temperature----------------------
            ...
            # Initial state
            'k0': 2.926,  # K0/(A0L0)
            'MAT0': 0.850,  # [1000 GtC] 2004
            'MUO0': 0.901,  # [1000 GtC] 2004
            'MLO0': 37.241, # [1000 GtC] 2004
            'MLF0': 0.446, # [1000 GtC] 2004
...
MUOx_state = []
MUOx_state.append({'name':'MUOx','init':{'distribution':'truncated_normal','kwargs': {'mean':0.901,'stddev':0.}}})

MLOx_state = []
MLOx_state.append({'name':'MLOx','init':{'distribution':'truncated_normal','kwargs': {'mean':37.241,'stddev':0.}}})

MLFx_state = []
MLFx_state.append({'name':'MLFx','init':{'distribution':'truncated_normal','kwargs': {'mean':0.446,'stddev':0.}}})
