...
constants = {'Tstep': 1, # Years in one time step
            ...
            'pow2': 2.,
            #----------------Carbon mass---------------------------------
            'b12_': 0.0646892,   # Rate of carbon diffusion from atmosphere to upper ocean
            'b23_': 0.0031686,   # Rate of carbon diffusion from upper ocean to lower ocean
            'MATeq': 0.589, # Equilibrium mass of carbon in the Atmosphere
            'MUOeq': 0.820, # Equilibrium mass of carbon in the upper Ocean
            'MLOeq': 36.790, #Equilibrium mass of carbon in the lower ocean
            ...
            'MUO0': 1.062,  # [1000 GtC] 2004
            'MLO0': 36.823, # [1000 GtC] 2004
...
MUOx_state = []
MUOx_state.append({'name':'MUOx','init':{'distribution':'truncated_normal','kwargs': {'mean':1.062,'stddev':0.}}})

MLOx_state = []
MLOx_state.append({'name':'MLOx','init':{'distribution':'truncated_normal','kwargs': {'mean':36.823,'stddev':0.}}})
