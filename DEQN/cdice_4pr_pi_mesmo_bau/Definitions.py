...
b12_, b23_, b14_, MATeq, MUOeq, MLOeq, MLFeq = Parameters.b12_, Parameters.b23_, Parameters.b14_, \
    Parameters.MATeq, Parameters.MUOeq, Parameters.MLOeq, Parameters.MLFeq
...
def b44(state, policy_state):
    """ Mass of carbon transmission"""
    return 1 - Tstep * b14_ * MATeq/MLFeq
