...
constants = {'Tstep': 1, # Years in one time step
            ...
            'pow2': 2.,
            #----------------Carbon mass---------------------------------
            'b12_': 0.0127,   # Rate of carbon diffusion from atmosphere to upper ocean
            'b23_': 0.0015,   # Rate of carbon diffusion from upper ocean to lower ocean
            'b14_': 0.0441,  # Rate of carbon diffusion from atmosphere to land biosphere
            'MATeq': 0.589, # Equilibrium mass of carbon in the Atmosphere
            'MUOeq': 0.769, # Equilibrium mass of carbon in the upper Ocean
            'MLOeq': 37.185, #Equilibrium mass of carbon in the lower ocean
            'MLFeq': 0.242, #Equilibrium mass of carbon in the lower ocean
            #-------------------Temperature----------------------
            ...
            # Initial state
            'k0': 2.926,  # K0/(A0L0)
            'MAT0': 0.853,  # [1000 GtC] 2004
            'MUO0': 0.870,  # [1000 GtC] 2004
            'MLO0': 37.191, # [1000 GtC] 2004
            'MLF0': 0.333, # [1000 GtC] 2004
...
MATx_state = []
MATx_state.append({'name':'MATx','init':{'distribution':'truncated_normal','kwargs': {'mean':0.853,'stddev':0.}}})

MUOx_state = []
MUOx_state.append({'name':'MUOx','init':{'distribution':'truncated_normal','kwargs': {'mean':0.870,'stddev':0.}}})

MLOx_state = []
MLOx_state.append({'name':'MLOx','init':{'distribution':'truncated_normal','kwargs': {'mean':37.191,'stddev':0.}}})

MLFx_state = []
MLFx_state.append({'name':'MLFx','init':{'distribution':'truncated_normal','kwargs': {'mean':0.333,'stddev':0.}}})
