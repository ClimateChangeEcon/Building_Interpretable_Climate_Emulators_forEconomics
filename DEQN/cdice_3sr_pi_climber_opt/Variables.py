...
constants = {'Tstep': 1, # Years in one time step
            ...
            'pow2': 2.,
            #----------------Carbon mass---------------------------------
            'b12_': 0.0903829,   # Rate of carbon diffusion from atmosphere to upper ocean
            'b23_': 0.0025088,   # Rate of carbon diffusion from upper ocean to lower ocean
            'MATeq': 0.589, # Equilibrium mass of carbon in the Atmosphere
            'MUOeq': 1.179, # Equilibrium mass of carbon in the upper Ocean
            'MLOeq': 37.142, #Equilibrium mass of carbon in the lower ocean
...
MUOx_state = []
MUOx_state.append({'name':'MUOx','init':{'distribution':'truncated_normal','kwargs': {'mean':1.531,'stddev':0.}}})

MLOx_state = []
MLOx_state.append({'name':'MLOx','init':{'distribution':'truncated_normal','kwargs': {'mean':37.181,'stddev':0.}}})
