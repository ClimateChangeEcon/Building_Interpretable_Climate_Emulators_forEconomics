...
constants = {'Tstep': 1, # Years in one time step
            ...
            'b23_': 0.0141,   # Rate of carbon diffusion from upper ocean to lower ocean
            'MATeq': 0.589, # Equilibrium mass of carbon in the Atmosphere
            'MUOeq': 0.433, # Equilibrium mass of carbon in the upper Ocean
            'MLOeq': 0.781, #Equilibrium mass of carbon in the lower ocean
            #-------------------Temperature----------------------
            ...
            'MUO0': 0.569,  # [1000 GtC] 2004
            'MLO0': 0.843, # [1000 GtC] 2004
...
MUOx_state = []
MUOx_state.append({'name':'MUOx','init':{'distribution':'truncated_normal','kwargs': {'mean':0.569,'stddev':0.}}})

MLOx_state = []
MLOx_state.append({'name':'MLOx','init':{'distribution':'truncated_normal','kwargs': {'mean':0.843,'stddev':0.}}})
...
policies = kplusy_policy + lambd_haty_policy +\
            ...
            nuLO_haty_policy + etaAT_haty_policy + etaOC_haty_policy 
