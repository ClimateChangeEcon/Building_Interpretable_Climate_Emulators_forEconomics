...
constants = {'Tstep': 1, # Years in one time step
            ...
            'MLFeq': 0.387, #Equilibrium mass of carbon in the lower ocean
            #-------------------Temperature----------------------
            ...
            'MUO0': 1.237,  # [1000 GtC] 2004
            'MLO0': 37.236, # [1000 GtC] 2004
            'MLF0': 0.531, # [1000 GtC] 2004
...
MUOx_state = []
MUOx_state.append({'name':'MUOx','init':{'distribution':'truncated_normal','kwargs': {'mean':1.237,'stddev':0.}}})

MLOx_state = []
MLOx_state.append({'name':'MLOx','init':{'distribution':'truncated_normal','kwargs': {'mean':37.236,'stddev':0.}}})

MLFx_state = []
MLFx_state.append({'name':'MLFx','init':{'distribution':'truncated_normal','kwargs': {'mean':0.531,'stddev':0.}}})
